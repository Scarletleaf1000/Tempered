package me.scarletleaf1000.tempered.screen.custom;
...
public class CrudeForgeMenu extends AbstractContainerMenu {
    private final CrudeForgeBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public CrudeForgeMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public CrudeForgeMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CRUDE_FORGE_MENU.get(), containerId);
        this.blockEntity = ((CrudeForgeBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CRUDE_FORGE.get());
    }
